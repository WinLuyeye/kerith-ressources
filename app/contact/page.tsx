    ...
    <div className="bg-gray-100 w-full min-h-screen">
      ...
      >
        ...
        <div className="max-w-7xl relative px-6 md:px-12">
          ...
          >
            KERITH RESOURCES SARL est une société minière congolaise engagée dans une exploitation responsable, durable et innovante de ses 30 concessions à Luozi, Kongo-Central.
          </motion.p>
        </div>
      </div>
...
>
  ...
  <ul className="font-medium text-lg space-y-3 z-10 relative">
    ...
    <li>01. Avenue OUA, République Démocratique du Congo,<br />
